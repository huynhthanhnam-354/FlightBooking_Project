    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/health", "/api/auth/**", "/api/ai/**", "/api/v1/ai/**", "/api/v1/combos/**", "/api/v1/promotions", "/api/v1/recommendations", "/api/v1/payments/vnpay-mock/**", "/api/bookings/payment-success/**", "/api/bookings/*/payment/mock-confirm/**", "/api/payments/vnpay-return/**", "/api/payments/vnpay-ipn/**").permitAll()
