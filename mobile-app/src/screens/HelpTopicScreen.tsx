...
const HELP_TEXT: Record<string, Partial<typeof HELP_EN>> = {
  ...
  ko: {
    loading_bookings: '예약을 불러오는 중...', book_first: '먼저 항공편 예약',
    checkin_title: '온라인 체크인', checkin_sub: 'PNR을 입력하고 승객을 확인한 뒤 앱에서 탑승권을 만드세요.',
    open_checkin: '체크인 열기', pnr_label: '예약 코드 / PNR', pnr_placeholder: '예: SKY123',
    last_name_label: '성 / 마지막 이름', last_name_placeholder: '예: Kim', missing_info_title: '정보 누락',
    missing_checkin_msg: '예약 코드와 승객의 성/마지막 이름을 입력하세요.', checkin_failed: '체크인 실패',
    checkin_now: '지금 체크인', checking_in: '체크인 중...', account_bookings: '내 계정의 예약',
    no_booking_checkin: '체크인 가능한 예약이 없습니다.', process: '절차', checked_in: '체크인 완료',
    checkin_step_1: '예약 코드와 승객 이름을 항공권과 동일하게 입력하세요.',
    checkin_step_2: '승객, 항공편, 위탁 수하물 정보를 확인하세요.',
    checkin_step_3: '체크인을 확정하고 휴대폰에 탑승권을 저장하세요.',
    flight: '항공편', boarding: '탑승', seat_label: '좌석', boarding_note: '위탁 수하물이 있으면 카운터 마감 전에 수하물 위탁 카운터로 가세요.',
  },
  ja: {
    loading_bookings: '予約を読み込み中...', book_first: '先にフライトを予約',
    checkin_title: 'オンラインチェックイン', checkin_sub: 'PNRを入力し、搭乗者を確認してアプリ内搭乗券を作成します。',
    open_checkin: 'チェックインを開く', pnr_label: '予約コード / PNR', pnr_placeholder: '例: SKY123',
    last_name_label: '姓 / ラストネーム', last_name_placeholder: '例: Tanaka', missing_info_title: '情報が不足しています',
    missing_checkin_msg: '予約コードと搭乗者の姓を入力してください。', checkin_failed: 'チェックインに失敗しました',
    checkin_now: '今すぐチェックイン', checking_in: 'チェックイン中...', account_bookings: 'アカウントの予約',
    no_booking_checkin: 'チェックイン可能な予約がありません。', process: '手順', checked_in: 'チェックイン済み',
    checkin_step_1: '航空券と同じ予約コードと搭乗者名を入力します。',
    checkin_step_2: '搭乗者、フライト、受託手荷物の詳細を確認します。',
    checkin_step_3: 'チェックインを確定し、搭乗券をスマートフォンに保存します。',
    flight: 'フライト', boarding: '搭乗', seat_label: '座席', boarding_note: '受託手荷物がある場合は、カウンター締切前に手荷物預けカウンターへお越しください。',
  },
  zh: {
    loading_bookings: '正在加载预订...', book_first: '先预订航班',
    checkin_title: '网上值机', checkin_sub: '输入 PNR，核验乘客，并在应用内生成登机牌。',
    open_checkin: '打开值机', pnr_label: '预订代码 / PNR', pnr_placeholder: '例如：SKY123',
    last_name_label: '姓 / 姓氏', last_name_placeholder: '例如：Wang', missing_info_title: '缺少信息',
    missing_checkin_msg: '请输入预订代码和乘客姓氏。', checkin_failed: '值机失败',
    checkin_now: '立即值机', checking_in: '正在值机...', account_bookings: '账户中的预订',
    no_booking_checkin: '没有可值机的预订。', process: '流程', checked_in: '已值机',
    checkin_step_1: '输入与机票一致的预订代码和乘客姓名。',
    checkin_step_2: '核对乘客、航班和托运行李信息。',
    checkin_step_3: '确认值机并将登机牌保存到手机。',
    flight: '航班', boarding: '登机', seat_label: '座位', boarding_note: '如有托运行李，请在柜台关闭前前往行李托运柜台。',
  },
  th: {
    loading_bookings: 'กำลังโหลดการจอง...', book_first: 'จองเที่ยวบินก่อน',
    checkin_title: 'เช็คอินออนไลน์', checkin_sub: 'กรอก PNR ตรวจสอบผู้โดยสาร และสร้างบอร์ดดิ้งพาสในแอป',
    open_checkin: 'เปิดเช็คอิน', pnr_label: 'รหัสการจอง / PNR', pnr_placeholder: 'เช่น SKY123',
    last_name_label: 'นามสกุล', last_name_placeholder: 'เช่น Somchai', missing_info_title: 'ข้อมูลไม่ครบ',
    missing_checkin_msg: 'กรุณากรอกรหัสการจองและนามสกุลผู้โดยสาร', checkin_failed: 'เช็คอินไม่สำเร็จ',
    checkin_now: 'เช็คอินตอนนี้', checking_in: 'กำลังเช็คอิน...', account_bookings: 'การจองในบัญชีของคุณ',
    no_booking_checkin: 'ไม่มีการจองที่สามารถเช็คอินได้', process: 'ขั้นตอน', checked_in: 'เช็คอินแล้ว',
    checkin_step_1: 'กรอกรหัสการจองและชื่อผู้โดยสารให้ตรงกับตั๋ว',
    checkin_step_2: 'ตรวจสอบผู้โดยสาร เที่ยวบิน และสัมภาระโหลด',
    checkin_step_3: 'ยืนยันเช็คอินและบันทึกบอร์ดดิ้งพาสไว้ในโทรศัพท์',
    flight: 'เที่ยวบิน', boarding: 'ขึ้นเครื่อง', seat_label: 'ที่นั่ง', boarding_note: 'หากมีสัมภาระโหลด กรุณาไปที่เคาน์เตอร์ฝากสัมภาระก่อนปิดรับ',
  },
  es: {
    loading_bookings: 'Cargando reservas...', book_first: 'Reserva un vuelo primero',
    checkin_title: 'Check-in en línea', checkin_sub: 'Ingresa el PNR, verifica el pasajero y crea una tarjeta de embarque en la app.',
    open_checkin: 'Abrir check-in', pnr_label: 'Código de reserva / PNR', pnr_placeholder: 'Ej.: SKY123',
    last_name_label: 'Apellido', last_name_placeholder: 'Ej.: García', missing_info_title: 'Falta información',
    missing_checkin_msg: 'Ingresa el código de reserva y el apellido del pasajero.', checkin_failed: 'Check-in fallido',
    checkin_now: 'Hacer check-in', checking_in: 'Haciendo check-in...', account_bookings: 'Reservas en tu cuenta',
    no_booking_checkin: 'No hay reservas disponibles para check-in.', process: 'Proceso', checked_in: 'CHECK-IN HECHO',
    checkin_step_1: 'Ingresa el código de reserva y el nombre del pasajero tal como aparecen en el boleto.',
    checkin_step_2: 'Revisa los datos del pasajero, vuelo y equipaje facturado.',
    checkin_step_3: 'Confirma el check-in y guarda la tarjeta de embarque en tu teléfono.',
    flight: 'Vuelo', boarding: 'Embarque', seat_label: 'Asiento', boarding_note: 'Si tienes equipaje facturado, ve al mostrador de entrega antes del cierre.',
  },
};
