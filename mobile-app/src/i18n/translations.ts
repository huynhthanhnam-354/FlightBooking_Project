...
type TranslationKeys = {
  ...
  confirmed: string; pending_payment: string; completed: string; cancelled: string; checked_in: string;
  pay_ticket: string; cancel_ticket: string; view_ticket: string; checkin_ticket: string;
  payment_confirm_title: string; payment_confirm_message: string;
  payment_success_title: string; payment_failed_title: string;
  cancel_booking_title: string; cancel_booking_message: string;
  cancel_booking_success_title: string; cancel_booking_failed_title: string;
...
const vi: TranslationKeys = {
  ...
  security: 'Bảo mật & Quyền riêng tư', support: 'Trung tâm hỗ trợ',
  ...
  confirmed: 'Đã xác nhận', pending_payment: 'Chờ thanh toán', completed: 'Đã hoàn thành', cancelled: 'Đã hủy', checked_in: 'Đã check-in',
  pay_ticket: 'Thanh toán', cancel_ticket: 'Hủy vé', view_ticket: 'Xem vé', checkin_ticket: 'Check-in',
  payment_confirm_title: 'Thanh toán vé', payment_confirm_message: 'Xác nhận thanh toán {amount} cho booking {booking}?',
  payment_success_title: 'Thanh toán thành công', payment_failed_title: 'Thanh toán thất bại',
  cancel_booking_title: 'Hủy vé', cancel_booking_message: 'Bạn có chắc muốn hủy booking {booking}?',
  cancel_booking_success_title: 'Đã hủy vé', cancel_booking_failed_title: 'Không hủy được vé',
  ...
  reset_link_demo: 'Yêu cầu khôi phục đã được ghi nhận. Cần cấu hình email để gửi liên kết đặt lại thật.',
  forgot_intro: 'Nhập email đã đăng ký để gửi yêu cầu đặt lại mật khẩu.',
...
const en: TranslationKeys = {
  ...
  security: 'Security & Privacy', support: 'Support center',
  ...
  confirmed: 'Confirmed', pending_payment: 'Pending Payment', completed: 'Completed', cancelled: 'Cancelled', checked_in: 'Checked in',
  pay_ticket: 'Pay', cancel_ticket: 'Cancel ticket', view_ticket: 'View ticket', checkin_ticket: 'Check in',
  payment_confirm_title: 'Pay ticket', payment_confirm_message: 'Confirm mock payment of {amount} for booking {booking}?',
  payment_success_title: 'Payment successful', payment_failed_title: 'Payment failed',
  cancel_booking_title: 'Cancel ticket', cancel_booking_message: 'Are you sure you want to cancel booking {booking}?',
  cancel_booking_success_title: 'Ticket cancelled', cancel_booking_failed_title: 'Could not cancel ticket',
  ...
  reset_link_demo: 'Recovery request accepted. Configure email delivery to send a real reset link.',
  forgot_intro: 'Enter your registered email to request a password reset.',
...
const ko: TranslationKeys = {
  ...
  return_date: '귀국일',
  fare_outbound: '가는 편 요금',
  fare_return_estimate: '오는 편 (예상)',
  ...
  trips: '항공편', member: '회원',
  confirmed: '예약 확정', pending_payment: '결제 대기', completed: '완료', cancelled: '취소됨', checked_in: '체크인 완료',
  pay_ticket: '결제', cancel_ticket: '항공권 취소', view_ticket: '항공권 보기', checkin_ticket: '체크인',
  payment_confirm_title: '항공권 결제', payment_confirm_message: '예약 {booking}에 대해 {amount} 모의 결제를 진행하시겠습니까?',
  payment_success_title: '결제 완료', payment_failed_title: '결제 실패',
  cancel_booking_title: '항공권 취소', cancel_booking_message: '예약 {booking}을 취소하시겠습니까?',
  cancel_booking_success_title: '항공권 취소 완료', cancel_booking_failed_title: '항공권을 취소할 수 없습니다',
...
const ja: TranslationKeys = {
  ...
  trips: '便', member: 'メンバー',
  confirmed: '予約確定', pending_payment: '支払い待ち', completed: '完了', cancelled: 'キャンセル済み', checked_in: 'チェックイン済み',
  pay_ticket: '支払う', cancel_ticket: '航空券をキャンセル', view_ticket: '航空券を見る', checkin_ticket: 'チェックイン',
  payment_confirm_title: '航空券の支払い', payment_confirm_message: '予約 {booking} の {amount} を模擬決済しますか？',
  payment_success_title: '支払い完了', payment_failed_title: '支払い失敗',
  cancel_booking_title: '航空券をキャンセル', cancel_booking_message: '予約 {booking} をキャンセルしますか？',
  cancel_booking_success_title: '航空券をキャンセルしました', cancel_booking_failed_title: '航空券をキャンセルできません',
...
const zh: TranslationKeys = {
  ...
  trips: '航班', member: '会员',
  confirmed: '已确认', pending_payment: '待付款', completed: '已完成', cancelled: '已取消', checked_in: '已值机',
  pay_ticket: '付款', cancel_ticket: '取消机票', view_ticket: '查看机票', checkin_ticket: '值机',
  payment_confirm_title: '支付机票', payment_confirm_message: '确认模拟支付预订 {booking} 的 {amount} 吗？',
  payment_success_title: '支付成功', payment_failed_title: '支付失败',
  cancel_booking_title: '取消机票', cancel_booking_message: '确定要取消预订 {booking} 吗？',
  cancel_booking_success_title: '机票已取消', cancel_booking_failed_title: '无法取消机票',
...
const th: TranslationKeys = {
  ...
  fare_outbound: 'ค่าโดยสารขาไป',
  fare_return_estimate: 'ขากลับ (ประมาณการ)',
  ...
  confirmed: 'ยืนยันแล้ว', pending_payment: 'รอการชำระเงิน', completed: 'เสร็จสิ้น', cancelled: 'ยกเลิกแล้ว', checked_in: 'เช็คอินแล้ว',
  pay_ticket: 'ชำระเงิน', cancel_ticket: 'ยกเลิกตั๋ว', view_ticket: 'ดูตั๋ว', checkin_ticket: 'เช็คอิน',
  payment_confirm_title: 'ชำระค่าตั๋ว', payment_confirm_message: 'ยืนยันการชำระเงินจำลอง {amount} สำหรับการจอง {booking}?',
  payment_success_title: 'ชำระเงินสำเร็จ', payment_failed_title: 'ชำระเงินไม่สำเร็จ',
  cancel_booking_title: 'ยกเลิกตั๋ว', cancel_booking_message: 'คุณแน่ใจหรือไม่ว่าต้องการยกเลิกการจอง {booking}?',
  cancel_booking_success_title: 'ยกเลิกตั๋วแล้ว', cancel_booking_failed_title: 'ไม่สามารถยกเลิกตั๋วได้',
...
const es: TranslationKeys = {
  ...
  fare_outbound: 'Tarifa de ida',
  fare_return_estimate: 'Vuelta (estimada)',
  ...
  confirmed: 'Confirmado', pending_payment: 'Pago pendiente', completed: 'Completado', cancelled: 'Cancelado', checked_in: 'Check-in realizado',
  pay_ticket: 'Pagar', cancel_ticket: 'Cancelar boleto', view_ticket: 'Ver boleto', checkin_ticket: 'Check-in',
  payment_confirm_title: 'Pagar boleto', payment_confirm_message: '¿Confirmar pago simulado de {amount} para la reserva {booking}?',
  payment_success_title: 'Pago exitoso', payment_failed_title: 'Pago fallido',
  cancel_booking_title: 'Cancelar boleto', cancel_booking_message: '¿Seguro que quieres cancelar la reserva {booking}?',
  cancel_booking_success_title: 'Boleto cancelado', cancel_booking_failed_title: 'No se pudo cancelar el boleto',
